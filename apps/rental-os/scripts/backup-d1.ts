...
const preBookingFoundation=args.schema==='pre-booking-foundation';const preAgreementFoundation=args.schema==='pre-agreement-foundation';if(args.schema&&!preBookingFoundation&&!preAgreementFoundation)throw new Error('Supported --schema values: pre-booking-foundation, pre-agreement-foundation.');
