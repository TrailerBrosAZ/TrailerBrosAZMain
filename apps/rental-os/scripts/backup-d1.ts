...
const preBookingFoundation=args.schema==='pre-booking-foundation';const preAgreementFoundation=args.schema==='pre-agreement-foundation';const preConversionFoundation=args.schema==='pre-conversion-foundation';const preSecureLinkFoundation=args.schema==='pre-secure-link-foundation';if(args.schema&&!preBookingFoundation&&!preAgreementFoundation&&!preConversionFoundation&&!preSecureLinkFoundation)throw new Error('Supported --schema values: pre-booking-foundation, pre-agreement-foundation, pre-conversion-foundation, pre-secure-link-foundation.');
