...
const tables = ['trailers','customers','reservations','availability_blocks','payments','condition_inspections','inspection_photos','cancellation_outcomes','deposit_decisions','audit_events'];
