...
const tables = ['trailers','customers','reservations','availability_blocks','booking_intents','delivery_quote_usage','secure_link_attempts','payments','payment_ledger_entries','payment_webhook_events','condition_inspections','inspection_photos','cancellation_outcomes','deposit_decisions','agreement_templates','agreement_instances','agreement_documents','pickup_condition_choices','booking_intent_conversions','secure_links','communication_records','audit_events'];
