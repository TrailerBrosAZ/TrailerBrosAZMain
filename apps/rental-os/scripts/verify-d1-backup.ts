...
const restoreOrder=['d1_migrations','trailers','customers','reservations','availability_blocks','booking_intents','delivery_quote_usage','secure_link_attempts','payments','agreement_templates','agreement_instances','agreement_documents','pickup_condition_choices','booking_intent_conversions','secure_links','audit_events','condition_inspections','inspection_photos','cancellation_outcomes','deposit_decisions'];
