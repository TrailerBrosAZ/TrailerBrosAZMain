...
export function migrate(db: Database.Database) {
  ...
  for (const name of ['0000_solid_demogoblin.sql', '0001_version_1b.sql', '0002_simple_the_watchers.sql', '0003_polite_tarot.sql', '0004_smart_lord_tyger.sql', '0005_powerful_infant_terrible.sql', '0006_messy_butterfly.sql', '0007_sudden_whistler.sql']) {
