...
type DeliveryQuote={status:'AVAILABLE'|'OUT_OF_AREA'|'ROUTING_UNAVAILABLE';available:boolean;zone:'ZONE_1'|'ZONE_2'|'ZONE_3'|null;feeCents:number|null;quotedAt:string};
